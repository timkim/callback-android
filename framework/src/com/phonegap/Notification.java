...
public class Notification extends Plugin {
	...
	public void beep(long count) {
		...
		Ringtone notification = RingtoneManager.getRingtone((Context) this.ctx, ringtone);
	...
	public synchronized void alert(final String message, final String title, final String buttonLabel, final String callbackId) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				...
				AlertDialog.Builder dlg = new AlertDialog.Builder((Context) ctx);
	...
	public synchronized void activityStart(final String title, final String message) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				notification.spinnerDialog = ProgressDialog.show((Context) ctx, title , message, true, true, 
	...
	public synchronized void progressStart(final String title, final String message) {
		...
		Runnable runnable = new Runnable() {
			public void run() {
				notification.progressDialog = new ProgressDialog((Context) ctx);
